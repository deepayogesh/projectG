...
input_title_info = get_inputTitle_info(input_movie_text)

print(f"Title: {input_movie_text}")
print(f"URL: {input_title_info['url']}")
print(f"Release Year: {input_title_info['releaseYear']}")
print(f"Average Rating: {input_title_info['averageRating']}")
print(f"Genres: {input_title_info['genres']}\n")


print("Generating Recommendations...\n")

recommendations = get_movies(input_movie_text)

for entry in recommendations:
    print(f"Title: {entry['title']}")
    print(f"URL: {entry['url']}")
    print(f"Release Year: {entry['releaseYear']}")
    print(f"Average Rating: {entry['averageRating']}")
