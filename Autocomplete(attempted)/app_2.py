...
def index():
    ...
    return render_template("index.html", errors=errors, movie=movie, input_title_info=input_title_info, recommendations=recommendations, movie_titles=movie_titles)
